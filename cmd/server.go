...
import (
	...
	"github.com/G-Research/tfe-plan-bot/server"
)
...
func init() {
	...
	ServerCmd.Flags().StringVarP(&serverCmdConfig.Path, "config", "c", "config/tfe-plan-bot.yml", "configuration file for tfe-plan-bot")
}